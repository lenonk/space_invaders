...
public:
    ...
    [[nodiscard]] virtual Vector2 &GetPosition();
    [[nodiscard]] virtual Rectangle GetRect();
    [[nodiscard]] virtual Texture2D &GetTexture();
    [[nodiscard]] virtual Texture2D &GetNextTexture();
    [[nodiscard]] virtual Sound &GetSound();
    [[nodiscard]] virtual Sound &GetNextSound();
