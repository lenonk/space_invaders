...
public:
    ...
    [[nodiscard]] virtual Vector2 GetPosition() const   { return m_position; }
    [[nodiscard]] virtual Sound GetSound() const        { return m_sounds[m_soundIdx]; }
    [[nodiscard]] virtual Texture2D GetTexture() const  { return m_textures[m_textureIdx]; }
    [[nodiscard]] virtual Rectangle GetRect() const;

    virtual Sound GetNextSound() const;
    virtual Texture2D GetNextTexture() const;
    ...
    [[nodiscard]] virtual bool CollidesWith(Entity &other) { return CollidesWith(other.GetRect()); }
